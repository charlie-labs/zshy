...
exports.createExportEqualsTransformer = void 0;
const ts = __importStar(require("typescript"));
// Create export = to export default transformer for ESM builds
const createExportEqualsTransformer = () => (context) => {
    return (sourceFile) => {
        const visitor = (node) => {
...
exports.createExportEqualsTransformer = createExportEqualsTransformer;
